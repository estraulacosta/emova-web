              ...
              >
                <g clipPath="url(#clip0_118_10264)">
                  ...
                  <path
                    ...
                    fill="var(--color-emova-secondary)"
                  />
                </g>
                <defs>
          ...
          <div className="hidden lg:block absolute left-0 top-0 bottom-0 z-20" style={{ overflow: 'visible' }}>
            ...
            >
              <svg 
                ...
                className="w-full h-auto"
              >
                <path d="M211.384 166.75H380C380 120.211 361.129 78.0759 330.611 47.5813L211.384 166.75Z" fill="var(--color-emova-primary)"/>
                <path d="M195.347 193.468V362C288.471 362 363.963 286.545 363.963 193.468H195.347Z" fill="var(--color-emova-secondary)"/>
                <path d="M168.616 0C75.4921 0 0 75.4548 0 168.532C0 215.071 18.8711 257.206 49.3884 287.701C79.8982 318.203 122.054 337.065 168.616 337.065V168.532L287.844 49.364C257.334 18.8618 215.178 0 168.616 0Z" fill="var(--color-emova-primary)"/>
              </svg>
            </motion.div>
          </div>
          ...
          <div className="lg:hidden absolute left-0 top-0 bottom-0 z-20" style={{ overflow: 'visible' }}>
            ...
            >
              <svg 
                ...
                fill="none" 
                xmlns="http://www.w3.org/2000/svg"
                className="relative w-full h-auto left-0 top-0 md:left-10 md:top-6"
              >
                <path d="M211.384 166.75H380C380 120.211 361.129 78.0759 330.611 47.5813L211.384 166.75Z" fill="var(--color-emova-primary)"/>
                <path d="M195.347 193.468V362C288.471 362 363.963 286.545 363.963 193.468H195.347Z" fill="var(--color-emova-secondary)"/>
                <path d="M168.616 0C75.4921 0 0 75.4548 0 168.532C0 215.071 18.8711 257.206 49.3884 287.701C79.8982 318.203 122.054 337.065 168.616 337.065V168.532L287.844 49.364C257.334 18.8618 215.178 0 168.616 0Z" fill="var(--color-emova-primary)"/>
