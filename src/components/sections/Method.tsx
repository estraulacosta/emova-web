      ...
      <div className="relative w-full flex justify-center items-center z-10 -mt-[30px] sm:-mt-[10px] md:mt-0 lg:mt-5" style={{ minHeight: 350 }}>
        ...
        >
          <g clipPath="url(#clip0_105_7205)">
            ...
            <path d="M851.07 397.47C851.07 396.01 851.03 394.57 851.01 393.11H734.79C734.82 394.56 734.85 396.01 734.85 397.47C734.85 459.17 709.65 514.98 668.98 555.18L751.16 637.36C812.86 576.12 851.07 491.26 851.07 397.47Z" fill="var(--color-emova-secondary)"/>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12 lg:gap-16">
              ...
              <div className="flex-shrink-0 flex justify-center w-full md:w-auto">
                ...
                <motion.div
                  ...
                  transition={{ duration: 1.1, ease: "easeOut" }}
                >
                  <EsferaDoble size={108} color1="var(--color-emova-primary)" color2="var(--color-emova-secondary)" opacity1={0.85} opacity2={0.85} />
                </motion.div>
              </div>
            </div>
            </div>
