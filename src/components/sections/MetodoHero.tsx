...
export default function MetodoHero() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[700px] bg-white overflow-hidden">
      {/* ...eliminar bloque de título 'Método' ... */}
      ...
      <div className="relative w-full flex justify-center items-center z-10" style={{ minHeight: 600, marginTop: '20px' }}>
        <svg width="966" height="795" viewBox="0 0 966 795" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-[80vw] md:max-w-[850px] w-full h-auto">
          <g clipPath="url(#clip0_105_7205)">
            <path d="M965.41 393.12C964.22 267.26 911.64 153.69 827.63 72.39L506.9 393.12L832.03 718.25C914.42 636.32 965.43 522.86 965.43 397.48C965.43 396.03 965.42 394.58 965.4 393.12H965.41Z" stroke="#05DBED" strokeWidth="2" strokeMiterlimit="10"/>
            <path d="M149.71 35.92C58.43 127.66 1.66 253.76 0.5 393.12H506.9L149.71 35.92Z" stroke="#05DBED" strokeWidth="2" strokeMiterlimit="10"/>
            ...
            <path d="M231.72 117.41C303.61 45.2 403.12 0.5 513.07 0.5C623.02 0.5 717.01 42.76 788.38 111.48" stroke="#05DBED" strokeWidth="2" strokeMiterlimit="10"/>
            <path d="M792.81 679.13C721.05 750.4 622.2 794.44 513.07 794.44C293.83 794.44 116.1 616.71 116.1 397.47C116.1 395.97 116.1 394.48 116.12 392.99" stroke="#05DBED" strokeWidth="2" strokeMiterlimit="10"/>
            <path d="M514.12 621.05C637.34 621.05 737.23 521.16 737.23 397.94C737.23 274.72 637.34 174.83 514.12 174.83C390.9 174.83 291.01 274.72 291.01 397.94C291.01 521.16 390.9 621.05 514.12 621.05Z" fill="#F7F7F7"/>
          </g>
          <defs>
        ...
        <div className="absolute top-1/2 left-1/2 z-20 flex flex-col items-center justify-center" style={{transform: 'translate(-50%, -50%)', maxWidth: '420px'}}>
          <h2 className="text-3xl md:text-4xl font-playfair font-bold text-[#B9C85E] text-center mb-2">Modelo de<br/>transformación <span className="text-[#9FB350]">neuroemocional™</span></h2>
      ...
      <Image src="/assets/Mano_C.png" alt="Mano C" width={320} height={320} className="absolute left-[45px] top-[80px] md:left-[5px] md:top-[120px] w-48 md:w-80 lg:w-36 pointer-events-none select-none" style={{zIndex: 5, transform: 'scale(1.25)'}} />
      <Image src="/assets/Mano_dedos.png" alt="Mano dedos" width={320} height={320} className="absolute right-[-80px] bottom-[-40px] md:right-[-120px] md:bottom-[-60px] w-48 md:w-80 lg:w-36 pointer-events-none select-none" style={{zIndex: 5, transform: 'scale(1.25)'}} />
