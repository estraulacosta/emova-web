...
export default function MetodoHero() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[700px] bg-white overflow-hidden">
      ...
      <Image src="/assets/Mano%20C.png" alt="Mano C" width={320} height={320} className="absolute left-[-80px] top-[80px] md:left-[-120px] md:top-[120px] w-48 md:w-80 pointer-events-none select-none" style={{zIndex: 5}} />
      <Image src="/assets/Mano%20dedos.png" alt="Mano dedos" width={320} height={320} className="absolute right-[-80px] bottom-[-40px] md:right-[-120px] md:bottom-[-60px] w-48 md:w-80 pointer-events-none select-none" style={{zIndex: 5}} />
