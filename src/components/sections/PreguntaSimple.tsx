...
export default function PreguntaSimple() {
  return (
    <section className="relative flex flex-col items-center justify-center pt-20 bg-emova-primary">
      ...
      <div className="hidden lg:block absolute top-0 left-0 w-full flex justify-center text-center pb-5">
        <span className="text-emova-secondary text-4xl font-semibold font-playfair">La pregunta es simple</span>
      </div>

      {/* Título arriba - Tablet y Móvil */}
      <div className="lg:hidden w-full flex justify-center">
        <span className="text-emova-secondary text-2xl md:text-2xl font-semibold font-playfair">La pregunta es simple</span>
      </div>
      ...
      <div className="hidden lg:block relative w-full " style={{height: 420, marginTop: '75px'}}>
        ...
        <div className="absolute bottom-8 z-20 flex justify-center items-center align-middle w-full">
          <Image
      ...
      <div className="hidden md:block lg:hidden relative w-full" style={{height: 350, marginTop: '20px'}}>
        <div style={{transform: 'rotate(180deg) translateY(10px)'}} className="z-10 flex justify-center items-center align-middle">
          <Image
            src="/assets/burbuja_final.svg"
            alt="Burbuja"
            width={450}
        ...
        {/* Persona sentada centrada */}
        <div className="relative bottom-6 z-20 flex justify-center items-center w-full" style={{transform: 'translateY(-138px)'}}>
          <Image
            src="/assets/Personas_Sentadas.png"
            alt="Persona Sentada"
            width={450}
      ...
      <div className="md:hidden relative w-full flex justify-center items-center align-middle" style={{height: 300, marginTop: '10px'}}>
        ...
        {/* Persona sentada centrada */}
        <div className="absolute z-20 flex justify-center items-center w-full" style={{transform: 'translateY(68%)'}}>
          <Image
            src="/assets/Personas_Sentadas.png"
            alt="Persona Sentada"
            width={320}
