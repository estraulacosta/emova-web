...
export default function PreguntaSimple() {
  return (
    <section className="relative flex flex-col items-center justify-center py-20 bg-emova-primary">
      {/* Título arriba */}
      <div className="absolute top-10 left-0 w-full flex justify-end pr-16" style={{transform: 'translateX(-500px)'}}>
        <span className="text-emova-secondary text-2xl font-semibold">La pregunta es simple</span>
      </div>
      ...
      <section className="w-full flex flex-col items-center justify-center py-40 min-h-[500px]" style={{background: '#F7F7F7', marginTop: '-92.5px'}}>
        ...
        <button className="inline-flex items-center gap-2 px-8 py-4 bg-emova-primary text-emova-white font-semibold rounded-full hover:bg-emova-tertiary transition-colors">
          Agenda tu diagnóstico neuroemocional gratuito
          <span className="bg-emova-white text-emova-primary rounded-full px-2 py-1 font-bold">+</span>
        </button>
      </section>
