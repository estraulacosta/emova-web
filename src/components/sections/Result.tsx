  ...
  return (
    <section className="pt-0 md:pt-20 pb-20 bg-emova-primary relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
        ...
        >
          <button className="bg-white hover:bg-gray-100 text-emova-primary font-libre font-bold px-8 py-4 rounded-full text-lg transition-colors flex items-center gap-2 mx-auto">
