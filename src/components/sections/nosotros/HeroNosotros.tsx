...
export default function HeroNosotros() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-visible pb-32 md:pb-0">
        {/* Green Circle SVG Background - At the very back, bottom */}
        <div className="absolute bottom-0 left-0 w-full pointer-events-none overflow-hidden z-0 translate-y-[1%] md:translate-y-[76.6%] lg:translate-y-[85%]">
          <img 
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-20 lg:mb-23">
              ...
              >
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[350px] md:h-[350px] lg:w-[350px] lg:h-[350px]">
                  <motion.div
      ...
      <section className="relative bg-emova-primary top-0 md:top-60 lg:top-100 pb-30 md:pb-60 lg:pb-80 pt-50 md:pt-10 lg:pt-0 overflow-hidden ">
        <div className="container mx-auto px-4 md:px-6">
          <div className="relative max-w-6xl mx-auto">
            
            {/* Arcos decorativos */}
            <div className="absolute left-0 top-1 w-20 md:w-32 lg:w-48 pointer-events-none z-0" style={{ transform: 'translateX(-25%)' }}>
            ...
            <div className="absolute right-0 top-1 w-20 md:w-32 lg:w-48 pointer-events-none z-0" style={{ transform: 'translateX(25%)' }}>
              <svg viewBox="0 0 245 489" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative z-10 text-center px-4 md:px-12 lg:px-20"
            >
              <h2 className="sm:text-2xl md:text-3xl lg:text-5xl font-playfair font-bold text-white mb-8 md:mb-10 lg:mb-12">
      ...
      <section className="relative bg-emova-primary top-12 md:top-40 lg:top-70 overflow-hidden pb-12 md:pb-0">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            >
              <div className="relative w-full max-w-[280px] md:max-w-[350px] lg:max-w-[450px] h-[280px] md:h-[350px] lg:h-[450px] flex items-center justify-center mx-auto">
                ...
                <div className="absolute w-[220px] h-[220px] md:w-[280px] md:h-[280px] lg:w-[350px] lg:h-[350px] rounded-full bg-emova-primary" />
            ...
            >
              ...
              <button className="bg-emova-primary text-white px-4 md:px-6 lg:px-8 py-2 md:py-3 rounded-full font-semibold hover:bg-emova-secondary transition-colors font-noto inline-flex items-center gap-2 text-xs md:text-sm lg:text-base mx-auto lg:mx-0">
